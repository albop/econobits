...
- Agent's behaviour does not take the full system into account. It is irrational in the sense that it isn't forward looking. Instead, an agent is given a behavioural heuristic.
