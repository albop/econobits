...
- Join on [Zulip](econforge.zulipchat.org) : we'll communicate in the `eco309_2026` room
...
-  Hands-on tutorial started in class can be (optionally)  completed and sent by Wednesday night.
