...
- Website: [econobits](http://econobits.org)
- Github repository for the course: [repo](https://github.com/albop/econobits)
  - 1 PR = 1 free coffee/tea!
- Join on [Zulip](econforge.zulipchat.org) : we'll communicate in the `scpo_2026` room
  - you're welcome to ask questions and answer other's questions (nicely)
  - outside of the course hours, I'll answer when I can
- Formal or infrequent communication: `pwinant@escp.eu` with subject starting by `[scpo]`

---

### Assignments and Final Exam

-  Hands-on tutorial started in class can be completed and sent by Wednesday night.
  - if you wish to have a correction, please ask expicitely
- There will be two special assignments with 14 days to complete each of them.
- Groupwork is OK.
- Final Exam will take place in the last session.
...
<img src=assets/vain_diagram.jpg width=30%>
