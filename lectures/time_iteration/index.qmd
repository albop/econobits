...
- The nature of the problem:
  ...
  - Today both are continuous: 
    - today, we have continuous decision rules
    - we will need to __discretize__, __interpolate__, __optimize__
    - we move to the field of *approximate dynamic programming*
...
- The solution metod:
  ...
  - And *value function iteration*, time permitting.
